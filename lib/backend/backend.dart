...
import 'schema/home_image_record.dart';
...
export 'schema/home_image_record.dart';
...
/// Functions to query HomeImageRecords (as a Stream and as a Future).
Future<int> queryHomeImageRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HomeImageRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HomeImageRecord>> queryHomeImageRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HomeImageRecord.collection,
      HomeImageRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HomeImageRecord>> queryHomeImageRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
